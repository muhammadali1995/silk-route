...
const Faq = () => {
  return (
    <div className="bg-vividPink font-ptSansNarrow  pt-[42px] pb-20 lg:pr-10 md:px-[27px] px-2 ">
      <div className="pt-20">
        {data[0].map((item, index) => {
          return (
            <div
              key={index}
              className="md:max-w-[947px] md:mx-auto w-full flex flex-col justify-center lg:px-0 px-2"
            >
              <div className="md:flex gap-2 text-springGreen font-anton lg:text-center pt-10">
                ...
                <p className="font-ptSansNarrow lg:text-3xl text-2xl text-justify">
                  {item.question}
                </p>
              </div>
              <div className="md:flex lg:pl-[60px] md:pl-8 gap-1 md:justify-center md::text-center">
                <div className="flex  pt-[12px] gap-1 items-center md:justify-center mx-w-[120px] h-min">
                ...
                <p className="font-ptSansNarrow text-delayedYellow pt-[15px] text-justify md:max-w-[770px] lg:text-xl text-[18px]">
                  {item.answer}
                </p>
              </div>
            </div>
        ...
        {data[1].map((item, index) => {
          return (
            ...
            >
              <div className="md:flex lg:pl-[15px] gap-2 lg:text-center text-left  pt-10">
              ...
              <div className="md:flex lg:pl-[80px] md:pl-8 gap-1 ">
